...
class LockerTest < ActiveSupport::TestCase
  ...
  test "A locker can have old rentals and current rentals" do
    ...
    rental_1 = locker.rentals.create(last_name: "G", phone_number: "111")
    rental_1.complete!
    rental_2 = locker.rentals.create(last_name: "G", phone_number: "111")
  ...
  test "A locker CANT have two active rentals" do
    locker = Locker.create
    rental_1 = locker.rentals.create(last_name: "G", phone_number: "111")
    rental_2 = locker.rentals.create(last_name: "G", phone_number: "123")
  ...
  test "locker#previous_rentals returns the all past rentals locker" do
    ...
    rental_2 = locker.rentals.create(last_name: "G", phone_number: "111")
    rental_2.complete!
    rental_3 = locker.rentals.create(last_name: "G", phone_number: "111")
